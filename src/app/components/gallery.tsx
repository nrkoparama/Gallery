...
export default function Gallery({ data }: { data: Picture[] }) {
  return (
      ...
      <div className="w-[90vw] mx-auto my-[10px]">
        <div className="w-[16rem] bg-[#fff] px-[28px] py-[18px] rounded-lg fixed top-[90px] left-[64px]">
          <div className="borderDel mb-4 border-b-2">
            <p className="tracking-wide font-medium mb-2">
              Danh mục ảnh
            </p>
        ...
        <div className="w-[68rem] ml-[292px] p-[28px] bg-[#fff] rounded-lg flex flex-wrap gap-0 justify-between">
          {data.map((picture) => (
            <div
              key={picture._id}
              className="w-[20rem] h-[240px] mb-4 p-[14px] hover:border-l-[3px] hover:border-b-[3px] border-slate-200 hover:shadow-lg cursor-pointer"
            >
              <img
                src="/images/beach-fernandesdn123.jpg"
                alt=""
