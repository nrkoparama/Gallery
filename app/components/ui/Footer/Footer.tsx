...
const schema = Yup.object().shape({
    email: Yup.string()
        ...
        .trim().email("* Email không hợp lệ"),
})

export default function Footer() {
    const {register, handleSubmit, clearErrors, formState: {errors}} = useForm<NewsLetterForm>({
        mode: "onSubmit",
    ...
    return (
        <section className={`container grid-rows-2 bg-white tracking-wide px-9 py-5 xl:p-8`}>
