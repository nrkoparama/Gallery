...
export default function PCHeader({author}: { author: Author | null }) {
    ...
    return (
        <nav className="grid grid-cols-3 items-center">
            ...
            <div>
                <Link href="/" className={`w-28 h-28 aspect-square mx-auto flex justify-center items-center`}>
                    <Image src="/assets/icons/neko.png" alt="Gallery logo" width={100} height={100} priority/>
                </Link>
            </div>
