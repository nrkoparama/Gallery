...
import HiddenMenu from "@/app/components/ui/Header/HiddenMenu";
    ...
    return (
        <nav
            ...
            <div className={`w-[90%] mx-auto flex justify-between items-center`}>
                ...
                <Link href="/" className={`w-[30%] flex justify-center items-center`}>
                ...
                <div className={`w-[30%] mt-6 flex justify-end`}>
                    ...
                    {author ?
                        ...
                        :
                        <User size={28} strokeWidth={1.5} onClick={() => router.push("/account/login")} className={`mr-2`}/>
                    }
